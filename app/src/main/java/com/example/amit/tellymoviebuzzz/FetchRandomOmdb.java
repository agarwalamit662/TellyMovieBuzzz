...
public class FetchRandomOmdb extends AsyncTask<String, Void, Void> {
    ...
    public FetchRandomOmdb(Context context) {
        mContext = context;
    }
        ...
        int numDays = 14;
                ...
                try {
                   ...
                   // String tmdbid = locationCursor1.getString(1);
                    ...
                    getMovieDataFromJson(forecastJsonStr, movieid);
