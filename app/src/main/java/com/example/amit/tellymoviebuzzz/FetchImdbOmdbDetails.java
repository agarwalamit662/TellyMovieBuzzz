...
public class FetchImdbOmdbDetails extends AsyncTask<String, Void, Void> {
    ...
    public FetchImdbOmdbDetails(Context context) {
        mContext = context;
    }
    ...
    private void getMovieDataFromJson(String forecastJsonStr,
        ...
        final String OWM_IMDB_ID = "imdbID";
        final String OWN_MOV_POSTER = "poster_path";
        final String OWN_IMDB_RATING = "imdbRating";
        ...
        try {
            ...
            String sMovieTypeWithMovieID =
                    MovieContract.MovieImdbEntry.TABLE_NAME+
                            "." + MovieContract.MovieImdbEntry.COLUMN_IMDB_ID + " = ? " ;
            // MovieContract.MovieNumberEntry.COLUMN_MOVIE_S  ETTING + " = ? ";
            ...
            if (locationCursor1.moveToFirst()) {
                ...
                inserted = mContext.getContentResolver().update(MovieContract.MovieImdbEntry.CONTENT_URI, movieValues,sMovieTypeWithMovieID,new String[]{imdbid});
