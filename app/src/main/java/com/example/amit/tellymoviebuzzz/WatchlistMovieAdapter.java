 ...
 */
public class WatchlistMovieAdapter extends CursorAdapter {
    ...
    public SharedPreferences.Editor editorwatchlist;
    ...
    public static class ViewHolderMovie {
        ...
        public final CheckBox towatch;
        public final NetworkImageView thumbNail;

        public ViewHolderMovie(View view) {
            // iconView = (ImageView) view.findViewById(R.id.list_item_icon);

            moviename = (TextView) view.findViewById(R.id.list_item_movie_watchlist_name);
            releasedate = (TextView) view.findViewById(R.id.list_item_movie_watchlist_reldate);
            watchlist = (TextView) view.findViewById(R.id.list_item_movie_watchlist_watched);
            towatch = (CheckBox) view.findViewById(R.id.checkbox_watchlist_movies);
            thumbNail =(NetworkImageView) view.findViewById(R.id.thumbnail_watchlist_movies);
        }
    }



    public WatchlistMovieAdapter(Context context, Cursor c, int flags) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.watchlistmovies_list_item, parent, false);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
       ...
       /* int viewType = getItemViewType(cursor.getPosition());
        ...
        viewHolder.thumbNail.setImageUrl(imageurl,imageLoader4);
        // Read date from cursor
        // long dateInMillis = cursor.getLong(ForecastFragment.COL_WEATHER_DATE);
        // Find TextView and set formatted date on it
        String movieName = cursor.getString(WatchlistMovieForecast.COL_MOVIE_NAME);
        viewHolder.moviename.setText(movieName);

        // Read weather forecast from cursor
        String releasedate = cursor.getString(WatchlistMovieForecast.COL_MOVIE_REL);
        ...
        SharedPreferences sharedPrefswatchlist = context.getSharedPreferences("sharedPrefsmoviewatched", Context.MODE_PRIVATE);

        final String movieidmain = cursor.getString(WatchlistMovieForecast.COL_MOVIE_SETTING);


        final int position = cursor.getPosition();

        editorwatchlist = sharedPrefswatchlist.edit();
        ...
        String movietype = cursor.getString(WatchlistMovieForecast.COL_MOVIE_TYPE);
        String watchlist;
        if(movietype.contentEquals("upcoming")) {
            watchlist = "Releasing";
            //boolean value = cursor.getInt(boolean_column_index)>0;
            boolean wl = cursor.getInt(WatchlistMovieForecast.COL_MOVIE_WL) > 0;
            ...
            if(sharedPrefswatchlist.getBoolean(movieidmain,false)==false)
                viewHolder.towatch.setVisibility(View.GONE);
           // viewHolder.towatch.
          //  viewHolder.towatch.setChecked(sharedPrefsmovie.getBoolean(movieidmain, false));
           ...
           // if(sharedPrefsmovie.getBoolean(movieidmain, false)==false)
                viewHolder.towatch.setVisibility(View.VISIBLE);
            viewHolder.towatch.setChecked(sharedPrefswatchlist.getBoolean(movieidmain, false));
        ...
        viewHolder.towatch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (((CheckBox) v).isChecked()) {
                    ...
                    editorwatchlist.putBoolean(movieidmain, true);
                    editorwatchlist.commit();
                    ...
                    editorwatchlist.putBoolean(movieidmain, false);
                    editorwatchlist.commit();
                    ...
                    if (locationCursor1.moveToFirst()) {
                        ...
                        movieValues.put(MovieContract.MovieNumberEntry.COLUMN_MOVIE_WATCHED, false);
                        // movieValues.put(MovieContract.SeriesNumberEntry.COLUMN_SERIES_NAME, movieName);
                        // movieValues.put(MovieContract.SeriesNumberEntry.COLUMN_SERIES_CATEGORY, "popular");
                        // movieValues.put(MovieContract.SeriesNumberEntry.COLUMN_SERIES_FOLLOWING, "yes");
                        // movieValues.put(MovieContract.SeriesNumberEntry.COLUMN_SERIES_POPULARITY, popularityvalue);
