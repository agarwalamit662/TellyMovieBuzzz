...
public class PopularAdapter extends CursorAdapter {
    ...
    public static class ViewHolderMovie {
        ...
        public ViewHolderMovie(View view) {
            ...
            moviename = (TextView) view.findViewById(R.id.list_item_movie_pop_name);
            releasedate = (TextView) view.findViewById(R.id.list_item_movie_pop_reldate);
            watchlist = (TextView) view.findViewById(R.id.list_item_movie_pop_watched);
            towatch = (Switch) view.findViewById(R.id.switch_popular_movies);
            thumbNail =(NetworkImageView) view.findViewById(R.id.thumbnail_popular_movies);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.popular_list_item, parent, false);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
       ...
       /* int viewType = getItemViewType(cursor.getPosition());
        ...
        String releasedate = cursor.getString(PopularFragment.COL_MOVIE_REL);
