...
public class FetchPopularTask extends AsyncTask<String, Void, Void> {
    ...
    public FetchPopularTask(Context context) {
        mContext = context;
    }
    ...
    private void getMovieDataFromJson(String forecastJsonStr,
        ...
        if (locationCursor.moveToFirst()) {
            ...
            while (locationCursor.isAfterLast() == false) {
                ...
                String wl = locationCursor.getString(locationCursor
                ...
                if(before==true){
                    ...
                    movieValues.put(MovieContract.MovieNumberEntry.COLUMN_MOVIE_REL_YEAR,type );
                    movieValues.put(MovieNumberEntry.COLUMN_MOVIE_WATCHLIST,wl );
                    ...
                    inserted = mContext.getContentResolver().update(MovieContract.MovieNumberEntry.CONTENT_URI, movieValues,sMovieTypeWithMovieID,new String[]{"upcoming",mov_sett});
        ...
        try {
            ...
            for(int i = 0; i < movieArray.length(); i++) {
                ...
                Cursor locationCursor1 = mContext.getContentResolver().query(
                        ...
                        new String[]{"thisyear",movieid},
                        null);
                int inserted=0;
                if (locationCursor1.moveToFirst()) {

                    //while (locationCursor.isAfterLast() == false) {
                        String relyear = locationCursor1.getString(locationCursor1
                                .getColumnIndex(MovieContract.MovieNumberEntry.COLUMN_REL_DATE));
                        String mov_sett = locationCursor1.getString(locationCursor1
                                .getColumnIndex(MovieContract.MovieNumberEntry.COLUMN_MOVIE_SETTING));
                        String ry = locationCursor1.getString(locationCursor1
                                .getColumnIndex(MovieContract.MovieNumberEntry.COLUMN_MOVIE_REL_YEAR));
                        String name = locationCursor1.getString(locationCursor1
                                .getColumnIndex(MovieContract.MovieNumberEntry.COLUMN_MOVIE_NAME));
                        String des = locationCursor1.getString(locationCursor1
                                .getColumnIndex(MovieContract.MovieNumberEntry.COLUMN_MOVIE_DES));
                        String type = locationCursor1.getString(locationCursor1
                                .getColumnIndex(MovieContract.MovieNumberEntry.COLUMN_MOVIE_TYPE));
                        String category = locationCursor1.getString(locationCursor1
                            .getColumnIndex(MovieContract.MovieNumberEntry.COLUMN_MOVIE_CATEGORY));
                        String watched = locationCursor1.getString(locationCursor1
                                .getColumnIndex(MovieNumberEntry.COLUMN_MOVIE_WATCHED));
                        String watchlist =  locationCursor1.getString(locationCursor1
                                .getColumnIndex(MovieNumberEntry.COLUMN_MOVIE_WATCHLIST));
                    ...
                    movieValues.put(MovieContract.MovieNumberEntry.COLUMN_REL_DATE, relyear);
                    movieValues.put(MovieContract.MovieNumberEntry.COLUMN_MOVIE_REL_YEAR,ry );
                    movieValues.put(MovieContract.MovieNumberEntry.COLUMN_MOVIE_CATEGORY,"popular" );


                    movieValues.put(MovieNumberEntry.COLUMN_MOVIE_IMAGEURL, imageurl);
                    movieValues.put(MovieNumberEntry.COLUMN_MOVIE_WATCHLIST, watched);
                    movieValues.put(MovieNumberEntry.COLUMN_MOVIE_WATCHED,watchlist);
                    ...
                    inserted = mContext.getContentResolver().update(MovieContract.MovieNumberEntry.CONTENT_URI, movieValues,sMovieTypeWithMovieID,new String[]{"thisyear",mov_sett});



                    //locationId = locationCursor.getLong(locationIdIndex);
                } else if(today.contentEquals(reldateupdate)){
                    ...
                    movieValues.put(MovieNumberEntry.COLUMN_MOVIE_CATEGORY, "popular");
