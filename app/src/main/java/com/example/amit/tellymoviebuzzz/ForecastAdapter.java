...
public class ForecastAdapter extends CursorAdapter {
    ...
    public SharedPreferences.Editor editorupcoming;
       ...
       // public final TextView lowTempView;
        ...
        public ViewHolderMovie(View view) {
           // iconView = (ImageView) view.findViewById(R.id.list_item_icon);
            ...
            moviename = (TextView) view.findViewById(R.id.list_item_movie_name_textview);
            releasedate = (TextView) view.findViewById(R.id.list_item_movie_reldate_textview);
            watchlist = (TextView) view.findViewById(R.id.list_item_movie_watchlist_textview);
            towatch = (Switch) view.findViewById(R.id.switch_upcoming_movies);
            thumbNail =(NetworkImageView) view.findViewById(R.id.thumbnail_upcoming_movies);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
      ...
      //  int viewType = getItemViewType(cursor.getPosition());
       ...
       // }
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.upcomingmovies_list_item, parent, false);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
       ...
       /* int viewType = getItemViewType(cursor.getPosition());
        ...
        String imageurl = cursor.getString(ForecastFragment.COL_MOVIE_URL);
       // viewHolder.iconView.setImageResource(R.drawable.ic_drawer);
        ...
        viewHolder.thumbNail.setImageUrl(imageurl,imageLoader1);
        // Read date from cursor
       // long dateInMillis = cursor.getLong(ForecastFragment.COL_WEATHER_DATE);
        // Find TextView and set formatted date on it
        String movieName = cursor.getString(UpcomingMoviesForecast.COL_MOVIE_NAME);
        viewHolder.moviename.setText(movieName);

        // Read weather forecast from cursor
        String releasedate = cursor.getString(UpcomingMoviesForecast.COL_MOVIE_REL);
       ...
       // boolean isMetric = Utility.isMetric(context);
        ...
        boolean wl = cursor.getInt(UpcomingMoviesForecast.COL_MOVIE_WL)>0;
       ...
       // double low = cursor.getDouble(ForecastFragment.COL_WEATHER_MIN_TEMP);
        ...
        final String movieidmain = cursor.getString(UpcomingMoviesForecast.COL_MOVIE_SETTING);


        final int position = cursor.getPosition();

        editorupcoming = sharedPrefsmovie.edit();
        ...
        viewHolder.towatch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (((Switch) v).isChecked()) {
                    ...
                    editorupcoming.putBoolean(movieidmain, true);
                    editorupcoming.commit();
                    ...
                    editorupcoming.putBoolean(movieidmain, false);
                    editorupcoming.commit();
